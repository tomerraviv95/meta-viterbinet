...
def add_offlinemetaviterbinet(all_curves, val_block_length, n_symbol):
    dec = METAVNETTrainer(val_SNR_start=12, val_SNR_end=12, val_SNR_step=2, val_block_length=val_block_length,
                          noisy_est_var=0, fading_in_channel=True, fading_in_decoder=False, use_ecc=True,
                          gamma_start=0.2, gamma_end=0.2, gamma_num=1, channel_type='ISI_AWGN',
                          channel_coefficients='time_decay', subframes_in_frame=5,
                          val_frames=20, eval_mode='by_word', n_symbols=n_symbol,
                          self_supervised=True, ser_thresh=0.02, online_meta=False,
                          weights_dir=os.path.join(WEIGHTS_DIR, f'meta_training_{val_block_length}'))
...
def add_onlinemetaviterbinet(all_curves, val_block_length, n_symbol):
    dec = METAVNETTrainer(val_SNR_start=12, val_SNR_end=12, val_SNR_step=2, val_block_length=val_block_length,
                          ...
                          channel_coefficients='time_decay', subframes_in_frame=5,
                          val_frames=20, eval_mode='by_word', n_symbols=n_symbol,
                          self_supervised=True, ser_thresh=0.02, online_meta=True,
                          weights_dir=os.path.join(WEIGHTS_DIR, f'meta_training_{val_block_length}'))
